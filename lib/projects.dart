      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              projetCard('JAVA', 'Calculator', 'Simple Calculator', '1'),
              projetCard('JAVA', 'StopWatch', 'Basic StopWatch', '1'),
              projetCard('JAVA', 'Funny Game','An entertaining game', '1'),
              projetCard('JAVA', 'Quiz', 'Offline Java Quiz', '1'),
             // projetCard('FLUTTER', 'Click 2 Code', 'An online code compiler', '10')
            ],
          ),
        ),
      ),
